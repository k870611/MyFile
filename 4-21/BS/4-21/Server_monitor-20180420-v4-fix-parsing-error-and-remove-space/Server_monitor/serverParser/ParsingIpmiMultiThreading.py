...
import threading
import serverParser.ipmiParser.parsingSDRList as parsingSDRList
import serverParser.ipmiParser.parsingSELList as parsingSELList
import serverParser.mysqlDBDeployment as mysqlDBDeployment
...
#        print("file to be parsed:",targetFileList)
    ...
    def run(self):
        print("Run(),file #:",self.fileListToBeParsed)
        ...
        for item in self.fileListToBeParsed:
            ...
            elif self.totalThreads == self.threadID:
        ...
        for targetFile in fileList:
            self.planList = list()
            self.parsingPlans = True
            print("====>file to be handled:",targetFile)
        ...
        for item in fileList:
            ...
            with open(newFile,"w") as f:
                ...
                command = DBCreate.storeProcedureInsertServerSdr('server_management', fieldValueForStoreProcedure)
                print("\n\n\n==> command for write:",newCommand)
                print("\n\n\n==> command for write:-----------Stored Procedure", command)
                f.write(newCommand)
