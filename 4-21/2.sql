...
INSERT INTO `acc_management` VALUES (1,'Admin','System Administrator','YWRtaW4=','','Admin@foxconn.com','',1,'',0,'2018-04-21 17:23:59',1),(2,'Demo','demo','ZGVtbw==','Default Organization1','demo@gmail.com','0999999999',0,'',0,'2018-04-14 09:17:57',2),(3,'Scheduler','Scheduler','c2NoZWR1bGVy','','Scheduler@foxconn.com','',1,'',0,'2018-04-14 09:17:57',2),(4,'Supervisor','System Supervisor','c3VwZXJ2aXNvcg==','','Supervisor@foxconn.com','',0,'2018-03-13 ~ 2018-03-14',0,'2018-04-14 09:17:57',2),(5,'kyLin','kyLin','a3lMaW4xMjM0','Default Organization1','kyLin@foxconn.com','0912345678',1,'',0,'2018-04-21 15:09:06',1),(6,'t1','t1','dDE=','','t1@foxconn.com','12345655555',1,'2018-03-23 ~ 2018-04-01',1,'2018-04-14 09:17:57',2),(10,'t2','t2','dDI=','Default Organization1','T2@mail.ocm','1234567890',0,'2018-03-28 ~ 2018-03-29',1,'2018-04-14 09:17:57',3),(12,'t3','t3','dDM=','','T222@mail.ocm','',1,'',0,'2018-04-14 10:23:18',3);
...
INSERT INTO `role` VALUES (1,'Manager1','Kylin Manager','KyLin Group',1,1,1),(2,'Operator','Kylin Operator','KyLin Group',2,1,1),(3,'Viewer','Kylin Viewer','KyLin Group',3,1,0);
...
CREATE TABLE `server` (
  ...
  `server_type` varchar(45) DEFAULT '',
...
INSERT INTO `server` VALUES (1,'10','192.168.1.121','30:0e:d5:ca:c4:96',0,'FunctionTag Demo','24 W','PSU0 Consumption:0.00W\r Psu01 Consumption:32.00 W','25℃','PECI _CPU0_DTS:0.00 ℃\r PECI_CPU01_DTS:0.00 ℃\r DIMM Temp:0.00 ℃\r Sys Inlet Temp: 29.00℃','Server Note Demo','2018-04-11 17:34:16','admin','YWRtaW4=',1,NULL,NULL,'',3),(2,'11','168.95.1.1','E4:11:5B:12:c0:t2',1,'168.95.1.2 Function Tag','2 W','PSU1 Consumption:0.00W \r\nPsu11 Consumption:32.00 W','250℃','PECI _CPU01_DTS:0.00 ℃ \r\nPECI_CPU11_DTS:0.00 ℃ \r\nDIMM Temp:0.00 ℃ \r\nSys Inlet Temp: 53.00℃','168.95.1.2 note 3','2018-04-21 09:53:46','root','MTIzNDU2',1,NULL,NULL,'JBOD',1),(3,'12','168.95.1.2','E4:11:5B:12:c0:t4',2,'F3','2 W','PSU1 Consumption:0.00W \r\n Psu11 Consumption:32.00 W','250℃','PECI _CPU01_DTS:0.00 ℃ \r\nPECI_CPU11_DTS:0.00 ℃ \r\nDIMM Temp:0.00 ℃ \r\nSys Inlet Temp: 53.00℃','n3','2018-04-20 08:23:22','root','MTIzNDU2',1,NULL,NULL,'',1);
...
INSERT INTO `server_fru` VALUES (1,'SDR[001b] IPMB','BMC',NULL,NULL,1),(2,'Baseboard FRU Size','2048',NULL,NULL,1);
...
INSERT INTO `server_lan` VALUES (1,'PEF Control','PEFenable DoEventMsgs',NULL,NULL,1),(2,'Channel 1 IP Address','192.168.1.121',NULL,NULL,1),(3,'Channel 1 IP addr src','DHCP',NULL,NULL,1);
...
CREATE TABLE `server_sdr` (
  ...
  CONSTRAINT `server_id` FOREIGN KEY (`server_id`) REFERENCES `server` (`server_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `server_sdr` VALUES (1,'P3V3_Sensor','Absent','0.0na','2018-04-21 13:24:00','{\"sdr list\": [{\"name\": \"SEL_Status\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"IPMI_Watchdog\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"P12V\", \"value\": \"11.84Volts\", \"status\": \"ok\"}, {\"name\": \"FAN4_RPM\", \"value\": \"0RPM\", \"status\": \"cr\"}, {\"name\": \"FAN1_RPM\", \"value\": \"0RPM\", \"status\": \"cr\"}, {\"name\": \"PS1_Ambient_Temp\", \"value\": \"30degreesC\", \"status\": \"ok\"}, {\"name\": \"FAN3_RPM\", \"value\": \"0RPM\", \"status\": \"cr\"}, {\"name\": \"Outlet_Temp\", \"value\": \"35degreesC\", \"status\": \"ok\"}, {\"name\": \"P12V_STBY\", \"value\": \"11.76Volts\", \"status\": \"ok\"}, {\"name\": \"FAN2_RPM\", \"value\": \"0RPM\", \"status\": \"cr\"}, {\"name\": \"FAN6_RPM\", \"value\": \"0RPM\", \"status\": \"cr\"}, {\"name\": \"FAN5_RPM\", \"value\": \"0RPM\", \"status\": \"cr\"}, {\"name\": \"P5V\", \"value\": \"4.97Volts\", \"status\": \"ok\"}, {\"name\": \"BAT_P3V\", \"value\": \"3.00Volts\", \"status\": \"ok\"}, {\"name\": \"PS2_Ambient_Temp\", \"value\": \"28degreesC\", \"status\": \"ok\"}, {\"name\": \"P3V3\", \"value\": \"3.29Volts\", \"status\": \"ok\"}, {\"name\": \"PCH_Temp\", \"value\": \"59degreesC\", \"status\": \"ok\"}, {\"name\": \"FPIO_CONN_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"Riser2_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"Riser3_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"Riser1_Temp\", \"value\": \"27degreesC\", \"status\": \"ok\"}, {\"name\": \"DIMMG0_Temp\", \"value\": \"38degreesC\", \"status\": \"ok\"}, {\"name\": \"CPU0_Temp\", \"value\": \"40degreesC\", \"status\": \"ok\"}, {\"name\": \"CPU1_Margin_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"CPU1_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"CPU0_Margin_Temp\", \"value\": \"60degreesC\", \"status\": \"ok\"}, {\"name\": \"DIMMG1_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"Front_BP_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"Rear_HDD2_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"Rear_HDD1_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"Rear_BP_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"CPU0_Status\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"CPU1_Status\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"CPU0_Hot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"CPU1_Hot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"DIMMG0_1_Hot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"DIMMG0_2_Hot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"DIMMG1_1_Hot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"DIMMG1_2_Hot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"CPU_CATERR\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"DIMM_Alert\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"BMC_Boot_Up\", \"value\": \"0x02\", \"status\": \"ok\"}, {\"name\": \"ACPI_PWR_Status\", \"value\": \"0x01\", \"status\": \"ok\"}, {\"name\": \"Button_Pressed\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"PS1_Current\", \"value\": \"4Amps\", \"status\": \"ok\"}, {\"name\": \"PS1_Voltage\", \"value\": \"12Volts\", \"status\": \"ok\"}, {\"name\": \"PS1_IN_PWR\", \"value\": \"80Watts\", \"status\": \"ok\"}, {\"name\": \"PS2_Voltage\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"PS2_Current\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"PS2_IN_PWR\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"P1_DEF_VRHot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"CPU_Error\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"P1_ABC_VRHot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"P0_ABC_VRHot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"P0_DEF_VRHot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"SystemReset\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"CPU0_VR_Hot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"CPU1_VR_Hot\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"PS1_Status\", \"value\": \"0x01\", \"status\": \"ok\"}, {\"name\": \"PS2_Status\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"CPU_MSMI\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"SystemEvent\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"Total_Power\", \"value\": \"80Watts\", \"status\": \"ok\"}, {\"name\": \"PS1_Temp\", \"value\": \"41degreesC\", \"status\": \"ok\"}, {\"name\": \"PS2_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"PowerFault\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"BIOS_Boot_Up\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"Memory_Status\", \"value\": \"0x00\", \"status\": \"ok\"}, {\"name\": \"OCP_LAN_Temp\", \"value\": \"noreading\", \"status\": \"ns\"}, {\"name\": \"Inlet_Temp\", \"value\": \"26degreesC\", \"status\": \"ok\"}]}',1),(2,'Sys Inlet Temp','OK','25.00 C',NULL,NULL,1),(3,'P5V_Sensor','Absent','0.0na',NULL,NULL,1);
...
--
-- Dumping routines for database 'kylin'
--
/*!50003 DROP PROCEDURE IF EXISTS `insert_tables_server_sdr` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_tables_server_sdr`(IN var_id VARCHAR(1000),IN var_timestamp VARCHAR(10000), IN var_server_id VARCHAR(10000), IN var_result json)
BEGIN
...
-- Dump completed on 2018-04-21 17:25:48
